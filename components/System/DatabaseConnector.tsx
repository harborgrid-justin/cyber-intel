      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          <div className="flex justify-between items-center mb-6">
            <h3 className="font-bold text-white uppercase tracking-widest">Database Adapter</h3>
            <Badge color={status === 'CONNECTED' ? 'green' : status === 'CONNECTING' ? 'yellow' : 'red'}>{status}</Badge>
          </div>
        ...
        <div className="flex flex-col gap-4">
           <Card className="p-4 flex-1 bg-slate-950 border-slate-800 relative overflow-hidden">
              <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')] opacity-10"></div>
              <h4 className="text-xs font-bold text-slate-500 uppercase mb-2 relative z-10">Adapter Traffic Monitor</h4>
           ...
           <div className="grid grid-cols-3 gap-4">
              <Card className="p-3 text-center">
                 <div className="text-[10px] text-slate-500 uppercase">Write Latency</div>
                 <div className="text-xl font-mono text-white font-bold">{providerType === 'SQL' ? '124ms' : '0ms'}</div>
              </Card>
              <Card className="p-3 text-center">
                 <div className="text-[10px] text-slate-500 uppercase">Active Conn</div>
