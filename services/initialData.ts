...
// They have been added to `constants/mockData.ts` to resolve this chain of errors.
// The multiple import statements have also been consolidated for clarity.
import { 
    MOCK_THREATS, MOCK_CASES, MOCK_ACTORS, MOCK_CAMPAIGNS, MOCK_FEEDS, MOCK_AUDIT_LOGS, MOCK_VULNERABILITIES, SYSTEM_NODES, MOCK_INCIDENT_REPORTS, MOCK_USERS, MOCK_VENDORS, MOCK_PLAYBOOKS, MOCK_CHAIN, MOCK_MALWARE, MOCK_LAB_JOBS, MOCK_DEVICES, MOCK_PCAPS, MOCK_VENDOR_FEEDS, MOCK_SCANNERS, MOCK_TACTICS, MOCK_TECHNIQUES, MOCK_SUB_TECHNIQUES, MOCK_GROUPS, MOCK_SOFTWARE, MOCK_MITIGATIONS, MOCK_DOMAIN, MOCK_BREACH, MOCK_GEO, MOCK_SOCIAL, MOCK_INTEGRATIONS, MOCK_PATCH_STATUS, MOCK_API_KEYS, MOCK_ENRICHMENT, MOCK_PARSERS, MOCK_NORMALIZATION, MOCK_POLICIES, MOCK_HONEYTOKENS, MOCK_RISK_FORECAST, MOCK_NIST_CONTROLS, MOCK_DARKWEB, MOCK_META, MOCK_TRAFFIC_FLOWS,
    DEFAULT_APP_CONFIG, MOCK_AI_CONFIG, MOCK_SCORING_CONFIG, DEFAULT_THEME_CONFIG, MOCK_NAVIGATION_CONFIG, MOCK_MODULES_CONFIG, MOCK_PERMISSIONS, MOCK_ROLES
