...
import { MOCK_PLAYBOOKS, MOCK_AUDIT_LOGS, MOCK_INCIDENT_REPORTS, MOCK_CHAIN, MOCK_MALWARE, MOCK_LAB_JOBS, MOCK_DEVICES, MOCK_PCAPS, MOCK_VENDOR_FEEDS, MOCK_ENRICHMENT, MOCK_PARSERS, MOCK_NORMALIZATION, MOCK_POLICIES, MOCK_HONEYTOKENS, MOCK_TRAFFIC_FLOWS } from '../constants/seeds/operations.seed';
import { MOCK_TACTICS, MOCK_TECHNIQUES, MOCK_SUB_TECHNIQUES, MOCK_GROUPS, MOCK_SOFTWARE, MOCK_MITIGATIONS, MOCK_DOMAIN, MOCK_BREACH, MOCK_GEO, MOCK_SOCIAL, MOCK_DARKWEB, MOCK_META, MOCK_RISK_FORECAST } from '../constants/seeds/osint.seed';
