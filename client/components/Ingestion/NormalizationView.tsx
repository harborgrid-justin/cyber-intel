...
const MOCK_MAPPINGS: NormalizationRule[] = [
  { id: 'n1', sourceField: 'c-ip', targetField: 'client.ip', transform: 'NONE', validation: 'VALID' },
  { id: 'n2', sourceField: 'cs-method', targetField: 'http.request.method', transform: 'UPPERCASE', validation: 'VALID' },
  { id: 'n3', sourceField: 'time_taken', targetField: 'event.duration', transform: 'NONE', validation: 'TYPE_MISMATCH' },
  { id: 'n4', sourceField: 'user_agent', targetField: 'user_agent.original', transform: 'TRIM', validation: 'VALID' },
  { id: 'n5', sourceField: 'x-forwarded-for', targetField: 'source.ip', transform: 'NONE', validation: 'MISSING_FIELD' },
];

const NormalizationView: React.FC = () => {
  const [mappings, setMappings] = useState<NormalizationRule[]>(MOCK_MAPPINGS);
